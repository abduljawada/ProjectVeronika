...
namespace Pathfinding.Serialization
{
    ...
    public class TinyJsonDeserializer
    {
        ...
        System.Object Deserialize(Type tp, System.Object populate = null)
        {
            ...
            else if (Type.Equals(tp, typeof(Mesh)) || Type.Equals(tp, typeof(Texture2D)) ||
                     Type.Equals(tp, typeof(Transform)) || Type.Equals(tp, typeof(GameObject)))
            {
