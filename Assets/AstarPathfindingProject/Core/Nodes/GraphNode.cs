...
namespace Pathfinding
{
    ...
    public abstract class GraphNode
    {
        ...
        {
            get { return Destroyed ? null : AstarData.GetGraph(this); }
        }
        ...
        {
            get { return NodeIndex == DestroyedNodeIndex; }
        }
        ...
        {
            get { return (nodeIndex & TemporaryFlag1Mask) != 0; }
            set { nodeIndex = (nodeIndex & ~TemporaryFlag1Mask) | (value ? TemporaryFlag1Mask : 0); }
        }
        ...
        {
            get { return (nodeIndex & TemporaryFlag2Mask) != 0; }
            set { nodeIndex = (nodeIndex & ~TemporaryFlag2Mask) | (value ? TemporaryFlag2Mask : 0); }
        }
        ...
        {
            get { return (flags & FlagsWalkableMask) != 0; }
            set
            {
        ...
        {
            get { return (int)((flags & HierarchicalIndexMask) >> FlagsHierarchicalIndexOffset); }
        ...
        {
            get { return (flags & HierarchicalDirtyMask) != 0; }
        ...
        public uint Area
        {
            get { return AstarPath.active.hierarchicalGraph.GetConnectedComponent(HierarchicalNodeIndex); }
        }
        ...
        {
            get { return (flags & FlagsGraphMask) >> FlagsGraphOffset; }
        ...
        public uint Tag
        {
            get { return (flags & FlagsTagMask) >> FlagsTagOffset; }
        ...
        public virtual bool ContainsConnection(GraphNode node)
        {
            ...
            GetConnections(neighbour => { contains |= neighbour == node; });
            return contains;
        }
        ...
        public virtual int GetGizmoHashCode()
        {
            ...
            return position.GetHashCode() ^ (19 * (int)Penalty) ^
                   (41 * (int)(flags & ~(HierarchicalIndexMask | HierarchicalDirtyMask)));
        }
        ...
        public virtual void DeserializeNode(GraphSerializationContext ctx)
        {
            ...
            Flags = (ctx.reader.ReadUInt32() & ~(HierarchicalIndexMask | HierarchicalDirtyMask)) |
                    (Flags & (HierarchicalIndexMask | HierarchicalDirtyMask));
