...
namespace Pathfinding
{
    ...
    public class NavMeshGraph : NavmeshBase, IUpdatableGraph
    {
        ...
        /// </summary>
        [JsonMember] public bool recalculateNormals = true;
        ...
        /// </summary>
        [JsonMember] Vector3 cachedSourceMeshBoundsMin;
        ...
        {
            get { return forcedBoundsSize.x; }
        }

        public override float TileWorldSizeZ
        {
            get { return forcedBoundsSize.z; }
        }
        ...
        {
            return new GraphTransform(Matrix4x4.TRS(offset, Quaternion.Euler(rotation), Vector3.one) *
                                      Matrix4x4.TRS(
                                          sourceMesh != null
                                              ? sourceMesh.bounds.min * scale
                                              : cachedSourceMeshBoundsMin * scale, Quaternion.identity, Vector3.one));
        }
