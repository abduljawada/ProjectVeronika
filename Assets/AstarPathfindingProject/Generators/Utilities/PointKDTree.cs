...
namespace Pathfinding
{
    ...
    public class PointKDTree
    {
        ...
        static readonly IComparer<GraphNode>[] comparers = new IComparer<GraphNode>[]
            { new CompareX(), new CompareY(), new CompareZ() };
        ...
        void GetNearestInternal(int index, Int3 point, NNConstraint constraint, ref GraphNode best,
        ...
        void GetNearestConnectionInternal(int index, Int3 point, NNConstraint constraint, ref GraphNode best,
