...
namespace Pathfinding
{
    ...
    public abstract class NavGraph : IGraphInternals
    {
        ...
        /// </summary>
        [JsonMember] public bool drawGizmos = true;
        ...
        public virtual NNInfoInternal GetNearest(Vector3 position, NNConstraint constraint, GraphNode hint)
        {
            ...
            float maxDistSqr = constraint == null || constraint.constrainDistance
        ...
        {
            get { return serializedEditorSettings; }
            set { serializedEditorSettings = value; }
        }
    ...
    public class GraphCollision
    {
                    ...
                    switch (rayDirection)
                    {
                        case RayDirection.Both:
                            return !Physics.Raycast(position, up, height, mask, QueryTriggerInteraction.Ignore) &&
                                   !Physics.Raycast(position + upheight, -up, height, mask,
                                       QueryTriggerInteraction.Ignore);
        ...
        public RaycastHit[] CheckHeightAll(Vector3 position, out int numHits)
        {
            ...
            numHits = Physics.RaycastNonAlloc(position + up * fromHeight, -up, hitBuffer, fromHeight + 0.005F,
                heightMask, QueryTriggerInteraction.Ignore);
 ...
 Physics.RaycastAll(position+up*fromHeight, -up, fromHeight+0.005F, heightMask, QueryTriggerInteraction.Ignore);
    ...
    public enum RayDirection
    {
        ...
        /// <summary>< Casts the ray from the bottom upwards</summary>
        Down,

        /// <summary>< Casts the ray from the top downwards</summary>
