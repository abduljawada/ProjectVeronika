...
namespace Pathfinding
{
    ...
    public class TriangleMeshNode : MeshNode
    {
        ...
        public override bool GetPortal(GraphNode toNode, System.Collections.Generic.List<Vector3> left,
            System.Collections.Generic.List<Vector3> right, bool backwards)
        {
            int aIndex, bIndex;
        ...
        public override float SurfaceArea()
        {
            ...
            return System.Math.Abs(VectorMath.SignedTriangleAreaTimes2XZ(holder.GetVertex(v0), holder.GetVertex(v1),
                holder.GetVertex(v2))) * 0.5f;
        }
        ...
        public override Vector3 RandomPointOnSurface()
        {
            ...
            return ((Vector3)(holder.GetVertex(v1) - holder.GetVertex(v0))) * r1 +
                   ((Vector3)(holder.GetVertex(v2) - holder.GetVertex(v0))) * r2 + (Vector3)holder.GetVertex(v0);
        }
