...
namespace Pathfinding
{
    ...
    public class GridNode : GridNodeBase
    {
        ...
        {
            get { return (InternalGridFlags & GridFlagsConnectionMask) == GridFlagsConnectionMask; }
        }
        ...
        public void SetConnectionInternal(int dir, bool value)
        {
            ...
            unchecked
            {
                gridFlags = (ushort)(gridFlags & ~((ushort)1 << GridFlagsConnectionOffset << dir) |
        ...
        public void SetAllConnectionInternal(int connections)
        {
            ...
            {
                gridFlags =
                    (ushort)((gridFlags & ~GridFlagsConnectionMask) | (connections << GridFlagsConnectionOffset));
            }
        ...
        {
            get { return (gridFlags & GridFlagsEdgeNodeMask) != 0; }
            set
            {
                unchecked
                {
