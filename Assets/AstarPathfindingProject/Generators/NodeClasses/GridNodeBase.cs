...
namespace Pathfinding
{
    ...
    public abstract class GridNodeBase : GraphNode
    {
        ...
        {
            get { return nodeInGridIndex & NodeInGridIndexMask; }
            set { nodeInGridIndex = (nodeInGridIndex & ~NodeInGridIndexMask) | value; }
        }
        ...
        {
            get { return NodeInGridIndex % GridNode.GetGridGraph(GraphIndex).width; }
        }
        ...
        {
            get { return (gridFlags & GridFlagsWalkableErosionMask) != 0; }
            set
            {
                unchecked
                {
                    gridFlags = (ushort)(gridFlags & ~GridFlagsWalkableErosionMask |
                                         (value ? (ushort)GridFlagsWalkableErosionMask : (ushort)0));
                }
            }
        }
        ...
        {
            get { return (gridFlags & GridFlagsWalkableTmpMask) != 0; }
            set
            {
                unchecked
                {
                    gridFlags = (ushort)(gridFlags & ~GridFlagsWalkableTmpMask |
                                         (value ? (ushort)GridFlagsWalkableTmpMask : (ushort)0));
                }
            }
        }
        ...
        public override Vector3 RandomPointOnSurface()
        {
            ...
            return gg.transform.Transform(graphSpacePosition +
